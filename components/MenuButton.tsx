...
//         >
//           <MenuItem >
//             <button onClick={()=> router.push('/supported/profile')} className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10">
...
//           </MenuItem>
//           <MenuItem>
//             <button onClick={()=> router.push('/supported/matara-ranks')} className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10">
...
export default function Example() {
  ...
  // Helper: safely load WebApp SDK in browser
  ...
  const openTelegramLink = async (url: string) => {
    if (typeof window === "undefined") return;
    const { default: WebApp } = await import("@twa-dev/sdk");
    ...
    <div>
      <Menu>
        ...
        >
          <MenuItem>
            <button
              onClick={() => router.push("/supported/profile")}
          ...
          <MenuItem>
            <button
              onClick={() => router.push("/supported/matara-ranks")}
              className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10"
            >
              <FaRankingStar className="text-[#FFC152] text-[23px]" />
              Matara Rankings
          ...
          <MenuItem>
            <button
              onClick={() =>
                openLink(
                  "https://drive.google.com/file/d/1HdyuPv6Mmxtvx58GJf3NiYPdfYIsKdsb/view?usp=sharing"
                )
              }
              className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10"
            >
          ...
          <MenuItem>
            <button
              onClick={() => openTelegramLink("http://t.me/MATARA_TOKEN")}
              className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10"
            >
              <RiTelegramLine className="text-[#FFC152] text-[25px]" />
              Our TG Channel
